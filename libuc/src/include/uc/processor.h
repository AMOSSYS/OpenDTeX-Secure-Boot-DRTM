...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%cs,%0" : "=r" (data));
    return (data);
}
...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%ds,%0" : "=r" (data));
    return (data);
}
...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%es,%0" : "=r" (data));
    return (data);
}
...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%ss,%0" : "=r" (data));
    return (data);
}
...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%fs,%0" : "=r" (data));
    return (data);
}
...
{
    uint16_t data;
    __asm__ __volatile__ ("mov %%gs,%0" : "=r" (data));
    return (data);
}

static inline void write_ds(uint16_t data)
{
    __asm__ __volatile__("mov %0,%%ds" : : "r" (data) : "memory");
}

static inline void write_es(uint16_t data)
{
    __asm__ __volatile__("mov %0,%%es" : : "r" (data) : "memory");
}

static inline void write_ss(uint16_t data)
{
    __asm__ __volatile__("mov %0,%%ss" : : "r" (data) : "memory");
}

static inline void write_fs(uint16_t data)
{
    __asm__ __volatile__("mov %0,%%fs" : : "r" (data) : "memory");
}

static inline void write_gs(uint16_t data)
{
    __asm__ __volatile__("mov %0,%%gs" : : "r" (data) : "memory");
}
...
static inline void invlpg(uintptr_t mem)
{
...
{
    uint16_t data;
    __asm__ __volatile__ ("str %0" : "=r" (data));
    return (data);
}

static inline void ltr(uint16_t data)
{
    __asm__ __volatile__ ("ltr %0" : : "r" (data));
}
   ...
   union {
      ...
      struct {
         ...
         struct {
            ...
            uint16_t DPL            : 2;
            uint16_t Present        : 1;
            uint16_t HighSegLimit   : 4;
            uint16_t AVL            : 1;
            uint16_t LongMode       : 1;
            uint16_t OperationSize  : 1;
            uint16_t Granularity    : 1;
         };
         uint8_t  HighBase;
      };
   };
} __attribute__((aligned(8))) gdt_descr_t;

typedef struct {
   uint16_t       limit;
   gdt_descr_t *  base;
} __attribute__((aligned(4))) gdt_descr_table_t;
...
typedef struct {
   union {
      ...
      struct {
         ...
         uint16_t HighHandler;
      };
   };
} __attribute__((aligned(8))) idt_descr_t;

typedef struct {
   uint16_t       limit;
   idt_descr_t *  base;
} __attribute__((aligned(4))) idt_descr_table_t;

#pragma pack(pop)

static inline void sgdt(gdt_descr_table_t * data)
{
    __asm__ __volatile__ ("sgdt (%0)" : : "r" (data));
}

static inline void lgdt(gdt_descr_table_t * data)
{
    __asm__ __volatile__ ("lgdt (%0)" : : "r" (data));
}

static inline void sidt(idt_descr_table_t * data)
{
    __asm__ __volatile__ ("sidt (%0)" : : "r" (data));
}

static inline void lidt(idt_descr_table_t * data)
{
    __asm__ __volatile__ ("lidt (%0)" : : "r" (data));
}

static inline uint16_t sldt(void)
{
    uint16_t data;
    __asm__ __volatile__ ("sldt %0" : "=r" (data));
    return (data);
}

static inline void lldt(uint16_t data)
{
    __asm__ __volatile__ ("lldt %0" : : "r" (data));
}
